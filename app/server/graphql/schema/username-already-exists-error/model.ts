...
/**
 * `POST /api/users` (`routes/users.ts`)'s two 409 branches, collapsed into one
 * honest member — both produce the identical body (`{ error: 'Username
 ...
 *    admin name (`routes/users.ts:132-136`) — checked BEFORE the length
