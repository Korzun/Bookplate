...
describe('createIpRateLimit (Task 4/12, unit-level — mirrors graphqlBodyLimit’s direct-call tests)', () => {
  ...
  // 'Login') — only the call shape changed, from positional args to options.
