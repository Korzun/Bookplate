...
export type SeriesRowFragmentFragment = { __typename: 'Series', id: string, name: string, author: string, bookCount: number, progressPercentage: number | null } & { ' $fragmentName'?: 'SeriesRowFragmentFragment' };
