...
export type SeriesRowFragmentFragment = { __typename: 'Series', id: string, name: string, author: string, bookCount: number, seriesProgress: number | null } & { ' $fragmentName'?: 'SeriesRowFragmentFragment' };
