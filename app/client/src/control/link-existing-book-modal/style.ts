...
// Identical to `control/link-progress-modal/style.ts`, minus the
// selected-item highlight that modal needs for its separate select-then-
// confirm step — this modal has no selection state to highlight, `onPick`
